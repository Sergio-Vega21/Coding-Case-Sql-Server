...
INSERT INTO Usuarios (nombreUsuario, emailUsuario, idRol, idDept, idJefe)
VALUES 
    ('Carlos G�mez', 'CarlosGomez@gmail.com', 2, 1, 1), -- Gerente de Recursos Humanos
    ('Ana Mart�nez', 'AnaMartinez@gmail.com', 2, 2, 1), -- Gerente de Finanzas
    ('Luis Rodr�guez', 'LuisRodriguez@gmail.com', 2, 3, 1), -- Gerente de TI
    ('Marta S�nchez', 'MartaSanchez@gmail.com', 2, 4, 1), -- Gerente de Ventas
    ('Pedro L�pez', 'PedroLopez@gmail.com', 2, 5, 1), -- Gerente de Marketing
    ('Sof�a Ram�rez', 'SofiaRamirez@gmail.com', 2, 6, 1), -- Gerente de Operaciones
    ('Javier Torres', 'JavierTorres@gmail.com', 2, 7, 1); -- Gerente de Atenci�n al Cliente
...
VALUES 
    -- Recursos Humanos
    ('Andrea Ram�rez', 'AndreaRamirez@gmail.com', 3, 1, (SELECT idUsuario FROM Usuarios WHERE idDept = 1 AND idRol = 2)),
    ('Diego Fern�ndez', 'DiegoFernandez@gmail.com', 3, 1, (SELECT idUsuario FROM Usuarios WHERE idDept = 1 AND idRol = 2)),
    -- Finanzas
    ('Beatriz G�mez', 'BeatrizGomez@gmail.com', 3, 2, (SELECT idUsuario FROM Usuarios WHERE idDept = 2 AND idRol = 2)),
    ...
    -- Ventas
    ('Isabel D�az', 'IsabelDiaz@gmail.com', 3, 4, (SELECT idUsuario FROM Usuarios WHERE idDept = 4 AND idRol = 2)),
    ('Juan Vega', 'JuanVega@gmail.com', 3, 4, (SELECT idUsuario FROM Usuarios WHERE idDept = 4 AND idRol = 2)),
    -- Marketing
    ('Karen M�ndez', 'KarenMendez@gmail.comm', 3, 5, (SELECT idUsuario FROM Usuarios WHERE idDept = 5 AND idRol = 2)),
    ('Leonardo Herrera', 'LeonardoHerrera@gmail.com', 3, 5, (SELECT idUsuario FROM Usuarios WHERE idDept = 5 AND idRol = 2)),
    -- Operaciones
    ('Marina Su�rez', 'MarinaSuarez@gmail.com', 3, 6, (SELECT idUsuario FROM Usuarios WHERE idDept = 6 AND idRol = 2)),
    ('Nicol�s Pardo', 'NicolasPardo@gmail.com', 3, 6, (SELECT idUsuario FROM Usuarios WHERE idDept = 6 AND idRol = 2)),
    -- Atenci�n al Cliente
    ('Olga R�os', 'OlgaRios@gmail.com', 3, 7, (SELECT idUsuario FROM Usuarios WHERE idDept = 7 AND idRol = 2)),
...
VALUES 
    ...
    ('Ricardo Mej�a', 'RicardoMejia@gmail.com', 4, 4, (SELECT TOP 1 idUsuario FROM Usuarios WHERE idDept = 4 AND idRol = 3)),
    ('Daniela Guti�rrez', 'DanielaGutierrez@gmail.com', 4, 5, (SELECT TOP 1 idUsuario FROM Usuarios WHERE idDept = 5 AND idRol = 3)),
    ('Juli�n Castillo', 'JulianCastillo@gmail.com', 4, 6, (SELECT TOP 1 idUsuario FROM Usuarios WHERE idDept = 6 AND idRol = 3)),
    ('Mariana Pe�a', 'MarianaPena@gmail.com', 4, 7, (SELECT TOP 1 idUsuario FROM Usuarios WHERE idDept = 7 AND idRol = 3)),
    ('Felipe C�rdenas', 'FelipeCardenas@gmail.com', 4, 2, (SELECT  TOP 1 idUsuario FROM Usuarios WHERE idDept = 2 AND idRol = 3)),
    ('Natalia Le�n', 'NataliaLeon@gmail.com', 4, 3, (SELECT TOP 1 idUsuario FROM Usuarios WHERE idDept = 3 AND idRol = 3));
